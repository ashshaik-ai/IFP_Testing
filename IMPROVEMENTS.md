...
7. 🟡 M — Complete the Telugu `CB_TE[]` translations of the 81 student-guidance card bodies (long-standing active item).
...
18. 🟡 S — "Up next" recommendation card at the end of each lesson (recommended-next exists on portal level; add per-lesson).
...
23. 🟡 M — Global client-side search index is curated (~44 entries); expand to cover every lesson + sub-section.
